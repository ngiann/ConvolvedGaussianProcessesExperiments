...
# Same as Experiment1, Experiment4 and Experiment5 but extreme noise
...
lambda, tobs, yobs, σobs, = simulatedatafromgp(mass=truemass, eddingtonfraction=trueedfrac, Tmax = 100, N=80, σ=10.0)
