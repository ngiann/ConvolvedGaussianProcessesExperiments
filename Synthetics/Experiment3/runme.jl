...
#
# This is the same as Synthetics\Experiment2 but now we change the scale of the irrelevant lightcurve
...
tobs[4], yobs[4], σobs[4] = tobsX[4], 0.2*yobsX[4].+8, σobsX[4]
...
savedfile = runexperiment(EXPERIMENT; transferFunctions = TF, tobs = tobs, yobs = yobs, σobs = σobs, kernelname = kernelname, fs = 100, ρmax = 15.0)
