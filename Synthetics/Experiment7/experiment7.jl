...
# There 4 lightcurves.
#
# Identical to experiment6 but different random seed for the generation of synthetic data.
#
# Run on hephaistos
#
...
tobs, yobs, σobs, tfarray, lambda = simulatenonoverlapping(N=50, mass=2e8, σ=1.0, seed=3);
...
JLD2.save("experiment7.jld2", "out", outparallel, "prob", prob, "lambda", lambda, "masses", masses, "eddingtonfraction", 10.0, "truemass", 2e8)
